...
**`/context migrate`**
- Copy intelligence from global (`~/.config/opencode/context/`) to local (`.opencode/context/`)
...
- Optionally cleans up global intelligence after migration
...
```bash
/context migrate
# Copies intelligence from ~/.config/opencode/context/ to .opencode/context/
