...
```typescript
import { createSession } from ".opencode/skills/task-management/scripts/session-context-manager";
...
```typescript
import { loadSession } from ".opencode/skills/task-management/scripts/session-context-manager";
