...
- **ExternalScout**: `.opencode/agents/subagents/core/external-scout.md` — Fetches and persists external docs
...
- **Library Registry**: the library registry — Supported libraries and query patterns
