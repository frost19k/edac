...
**Context Needed**:
- Design system standards (web/design-systems.md)
...
task(
  ...
  - .opencode/context/web/design-systems.md
  - .opencode/context/web/animation-basics.md
...
❌ **Task is testing/validation** → Wrong subagent (use test-engineer)  
❌ **Task is code review** → Wrong subagent (use code-reviewer)  
...
**Design System**:
- `web/design-systems.md` - Theme templates, color systems
- `web/ui-styling-standards.md` - Tailwind, Flowbite, responsive design
- `web/design-assets.md` - Images, icons, fonts
