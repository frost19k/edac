  ...
  <workflow_execution>
    <stage id="0" name="ContextLoading">
      ...
      <process>
        ...
        3. If context bundle provided, load and extract (see `core/standards/glossary.md` for the definition of "context bundle"):
    ...
    <!-- P2-5-i: Sequencing — Call ContextScout first; only clarify with the user if ContextScout results are insufficient. -->
        ...
        1. Create directory:
          ...
          3. Create subtask_NN.json for each task:
              ...
              **FRONTEND RULE**: If a task involves UI design, styling, or frontend implementation:
              1. Set `suggested_agent`: "FrontendSpecialist"
              2. Include `.opencode/context/core/workflows/design-iteration-overview.md` in `context_files`.
